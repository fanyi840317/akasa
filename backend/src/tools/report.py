...
class ReportGenerator(BaseTool):
    ...
    def _run(self, report_data: str, format_type: str = "markdown", output_path: Optional[str] = None) -> str:
        """生成报告
    ...
    def _generate_markdown_report(self, data: Dict[str, Any], output_path: Optional[str] = None) -> str:
        """生成Markdown格式报告"""
        try:
            # 构建报告内容
    ...
    def _generate_pdf_report(self, data: Dict[str, Any], output_path: Optional[str] = None) -> str:
        """生成PDF格式报告"""
        try:
            # 首先生成HTML内容
    ...
    def _generate_html_report(self, data: Dict[str, Any], output_path: Optional[str] = None) -> str:
        """生成HTML格式报告"""
        try:
            html_content = self._build_html_content(data)
