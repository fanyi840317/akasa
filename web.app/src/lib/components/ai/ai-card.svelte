...
<div
  class="fixed bg-white dark:bg-neutral-800 border border-neutral-200/50 dark:border-neutral-700/50 rounded-lg shadow-lg p-2 flex flex-col gap-2 z-50 ai-card"
